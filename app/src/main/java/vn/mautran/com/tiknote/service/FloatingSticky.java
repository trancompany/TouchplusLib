package vn.mautran.com.tiknote.service;
...
import vn.mautran.com.tiknote.MainActivity;
import vn.mautran.com.tiknote.R;
...
public class FloatingSticky extends StandOutWindow {
    ...
    public void createAndAttachView(int id, FrameLayout frame) {
        ...
        Button fbt = (Button) frame.findViewById(R.id.floatButton);
        if (fbt == null)
            Log.i("FloatingStick","Floating Button is null");
        else {
            fbt.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    // click handling code
                    Log.i("FloatingStick", "Click Floating Button");
                }
            });
        }
    }
    ...
    public boolean onFocusChange(int id, Window window, boolean focus) {
        Log.i("FloatingSticky","onFocusChange focus:"+focus);
        if (focus) {
    ...
    @Override
    public boolean onClickSend(int id) {
        Log.i("FloatingSticky","onClickSend id:"+id);
        return false;
    }
